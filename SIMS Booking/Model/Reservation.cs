...
namespace SIMS_Booking.Model
{
    public class Reservation : ISerializable, IDable
    {
        ...
        public string[] ToCSV()
        {            
            string[] csvValues = { ID.ToString(), StartDate.ToShortDateString(), EndDate.ToShortDateString(), HasOwnerReviewed.ToString(), HasGuestReviewed.ToString(), IsCanceled.ToString(), IsCancellationReviewed.ToString()};
            return csvValues;
        }        
    }
}
